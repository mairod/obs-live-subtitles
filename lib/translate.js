...
// The provisional lane translates partial transcripts, so the input is usually
// an unfinished clause — the model must render what is there, not guess an
// ending it would then have to revise.
const SYSTEM =
  'You produce English subtitles for a live French conference stream. ' +
  'Translate the French into natural, accurate English. Preserve every ' +
  'detail — never summarise, compress, or omit. The text is often an ' +
  'unfinished sentence: translate only what is there and never guess how it ' +
  'ends. Output ONLY the subtitle line — no quotes, no commentary, no notes ' +
  'about the language. Earlier subtitles may be provided as context; do not ' +
  're-translate them.';
