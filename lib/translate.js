...
const SYSTEM =
  ...
  'natural, concise English. If the text is already English, output it ' +
  'unchanged. For mixed sentences, translate only the French parts. Output ' +
  'ONLY the subtitle line — no quotes, no commentary, no notes about the ' +
  'language. Earlier subtitles may be provided as context; do not re-translate ' +
  'them.';
